...
export function RoutesPage() {
    ...
    const activeRate = stats.total > 0 ? Math.round(((stats.planned + stats.inProgress) / stats.total) * 100) : 0
            ...
            <motion.div variants={itemVariants}>
                    ...
                    <div className={viewMode === 'grid' 
                        ...
                        {filteredAndSortedRoutes.map((route, index) => {
                            const StatusIcon = getStatusIcon((route.status as RouteStatus) || 'PLANNED')
                            return (
                                <motion.div
                                    key={route.id}
