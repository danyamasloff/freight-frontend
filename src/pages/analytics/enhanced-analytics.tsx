			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				<Card>
					...
					<CardContent>
						...
						<div
							className={`flex items-center text-sm ${getChangeClass(analyticsData.revenue.change)}`}
						>
				...
				<Card>
					...
					<CardContent>
						<div className="text-2xl font-bold">
							{formatCurrency(analyticsData.costs.current)}
						</div>
						<div
							className={`flex items-center text-sm ${getChangeClass(-analyticsData.costs.change)}`}
						>
				...
				<Card>
					...
					<CardContent>
						<div className="text-2xl font-bold">
							{formatCurrency(analyticsData.profit.current)}
						</div>
						<div
							className={`flex items-center text-sm ${getChangeClass(analyticsData.profit.change)}`}
						>
							...
							<CardContent className="space-y-4">
								<div>
									<div className="flex justify-between text-sm mb-2">
										...
										<span>
											{analyticsData.efficiency.vehicleUtilization.toFixed(1)}
											%
										</span>
									</div>
								...
								<div>
									<div className="flex justify-between text-sm mb-2">
										...
										<span>
											{analyticsData.efficiency.driverUtilization.toFixed(1)}%
										</span>
									</div>
				...
				<TabsContent value="routes" className="space-y-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Анализ наиболее востребованных направлений
							</CardDescription>
						</CardHeader>
						<CardContent>
									...
									>
										<div className="flex-1">
											...
											<p className="text-sm text-muted-foreground">
												{route.frequency} поездок • {route.averageTime}{" "}
												среднее время
											</p>
										</div>
									...
									>
										<div className="flex items-center gap-4">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground">
													{driver.routes} маршрутов • Рейтинг:{" "}
